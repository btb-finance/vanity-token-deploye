...
import { createErrorParser, withLayerZeroArtifacts, withLayerZeroDeployments, resolveSimulationConfig, getHardhatNetworkOverrides } from '@layerzerolabs/devtools-evm-hardhat';
...
extendConfig((config, userConfig) => {
  ...
  if (process.env.LZ_EXPERIMENTAL_WITH_SIMULATION) {
    ...
    logger.warn("");
    const simulationConfig = resolveSimulationConfig((_d = (_c = layerZero == null ? void 0 : layerZero.experimental) == null ? void 0 : _c.simulation) != null ? _d : {}, config);
