...
var GnosisOmniSignerEVM = class extends OmniSignerEVMBase {
  constructor(eid, signer, safeUrl, safeConfig, ethAdapter = new EthersAdapter({
    ethers,
    signerOrProvider: signer
  }), apiKit = new SafeApiKit({ txServiceUrl: safeUrl, ethAdapter }), safeSdkPromise = Safe.create({
    ethAdapter,
